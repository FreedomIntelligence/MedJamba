...
def train(args):
    ...
    left_tokenizer = AutoTokenizer.from_pretrained(args.model_path, padding_side='left', trust_remote_code=True)
    ...
    gen_kwargs = {'num_return_sequences': args.num_return, 'max_new_tokens':256,'min_new_tokens':2, 'do_sample':False}
    ...
    if args.eval_step <= 0:
        args.eval_step=len(train_dataloader)
